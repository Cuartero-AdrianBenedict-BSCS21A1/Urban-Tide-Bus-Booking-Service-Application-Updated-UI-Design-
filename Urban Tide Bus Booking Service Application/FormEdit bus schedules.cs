    ...
    public partial class FormEdit_bus_schedules : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.TryParseExact(timeInput, formats, CultureInfo.InvariantCulture, DateTimeStyles.None, out parsedTime))
            {
                ...
                dataGridView2Bussched.Rows.Add(parsedTime.ToString("h:mm tt")); // Standardized format
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2Bussched.SelectedRows.Count > 0)
            {
                // Get the index of the selected row
                int selectedRowIndex = dataGridView2Bussched.SelectedRows[0].Index;

                // Remove the selected row
                dataGridView2Bussched.Rows.RemoveAt(selectedRowIndex);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2Bussched.SelectedRows.Count > 0)
            {
                ...
                if (DateTime.TryParseExact(newTime, formats, CultureInfo.InvariantCulture, DateTimeStyles.None, out parsedTime))
                {
                    ...
                    dataGridView2Bussched.Rows[selectedRowIndex].Cells["Time"].Value = parsedTime.ToString("h:mm tt");
